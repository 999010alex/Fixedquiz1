...
if Q1response =="A" or Q1response =="a":
    ...
    print("THAT IS INCORRECT YOU FOOL! The correct answer was A.")
...
if Q1response =="B" or Q1response =="b":
    ...
    print("You got this one wrong boi, the correct answer was b.")
...
if Q1response =="C" or Q1response =="c":
    ...
    print("Come on man this isin't even that hard... The right awnser is c. ")
...
if Q1response =="B" or Q1response =="b":
    ...
    print("wrong...The right awnser was B.")
...
if Q1response =="A" or Q1response =="A":
    ...
    print("This was not that difficult, and yet you somehow failed, good job. The right awnser was A.")
...
print("C. Because he was happy he was done with this quiz")
Q1answer = 'c'
Q1response = input('your answer: ')
if Q1response =="C" or Q1response =="c":
    print("Well done " + name + " your response is correct!")
